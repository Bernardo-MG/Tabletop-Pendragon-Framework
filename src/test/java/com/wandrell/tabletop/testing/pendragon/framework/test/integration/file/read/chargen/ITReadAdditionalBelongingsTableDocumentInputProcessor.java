...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.chargen.AdditionalBelongingsTableDocumentInputProcessor;
...
public final class ITReadAdditionalBelongingsTableDocumentInputProcessor {

    private AdditionalBelongingsTable table;

    public ITReadAdditionalBelongingsTableDocumentInputProcessor() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final JDOMDocumentInputProcessor<AdditionalBelongingsTable> processor;
        ...
        processor = new AdditionalBelongingsTableDocumentInputProcessor(
                modelService, horseRepository, itemRepository, petRepository,
                shieldRepository, weaponRepository);
        parser = new JDOMStAXInputParser<AdditionalBelongingsTable>(processor);
