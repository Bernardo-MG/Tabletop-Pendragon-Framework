...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.chargen.CultureDocumentParser;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.TestModelFileConf;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.factory.TestServiceFactory;
import com.wandrell.util.ResourceUtils;

public final class ITReadCultureTemplateDocumentParser {

    private CultureTemplate culture;

    public ITReadCultureTemplateDocumentParser() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final Parser<Document, CultureTemplate> parserDoc;
        ...
        parserDoc = new CultureDocumentParser(modelService,
                characteristicRepository, belongingsRepository);
        parserFile = new XMLFileParser();

        culture = parserDoc.parse(parserFile.parse(ResourceUtils
