...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.chargen.AdditionalBelongingsTableDocumentParser;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.TestModelFileConf;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.factory.TestServiceFactory;
import com.wandrell.util.ResourceUtils;

public final class ITReadAdditionalBelongingsTableDocumentParser {

    private AdditionalBelongingsTable table;

    public ITReadAdditionalBelongingsTableDocumentParser() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final Parser<Document, AdditionalBelongingsTable> parserDoc;
        ...
        parserDoc = new AdditionalBelongingsTableDocumentParser(modelService,
