...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.character.HorseDocumentInputProcessor;
...
public final class ITReadHorseDocumentInputProcessor {

    private HorseCharacter horse;

    public ITReadHorseDocumentInputProcessor() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final JDOMDocumentInputProcessor<HorseCharacter> processor;
        final ModelService modelService;

        modelService = TestServiceFactory.getInstance().getModelService();

        processor = new HorseDocumentInputProcessor(modelService);
        parser = new JDOMStAXInputParser<HorseCharacter>(processor);
