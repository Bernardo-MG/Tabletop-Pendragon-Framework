...
public final class ITReadRangedWeaponDocumentInputProcessor {

    private Weapon weapon;

    public ITReadRangedWeaponDocumentInputProcessor() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        weapon = parser.read(ResourceUtils
                .getClassPathInputStream(FileConf.WEAPON_RANGED));
    }
