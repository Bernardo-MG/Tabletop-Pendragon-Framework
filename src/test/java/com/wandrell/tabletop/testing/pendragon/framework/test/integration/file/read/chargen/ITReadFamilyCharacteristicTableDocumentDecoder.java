...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.chargen.FamilyCharacteristicTableDocumentDecoder;
...
public final class ITReadFamilyCharacteristicTableDocumentDecoder {
    ...
    public ITReadFamilyCharacteristicTableDocumentDecoder() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final JDOMDocumentDecoder<FamilyCharacteristicTable> decoder;
        final ModelService modelService;

        modelService = TestServiceFactory.getInstance().getModelService();

        decoder = new FamilyCharacteristicTableDocumentDecoder(modelService);
        parser = new StAXInputParser<FamilyCharacteristicTable>(decoder);
