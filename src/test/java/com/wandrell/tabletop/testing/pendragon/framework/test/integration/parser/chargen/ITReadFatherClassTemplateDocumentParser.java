...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.chargen.FatherClassTemplateDocumentParser;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.TestModelFileConf;
import com.wandrell.tabletop.testing.pendragon.framework.framework.conf.factory.TestServiceFactory;
import com.wandrell.util.ResourceUtils;

public final class ITReadFatherClassTemplateDocumentParser {

    private FatherClassTemplate fatherClass;

    public ITReadFatherClassTemplateDocumentParser() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final Parser<Document, FatherClassTemplate> parserDoc;
        final ModelService modelService;

        modelService = TestServiceFactory.getInstance().getModelService();

        parserDoc = new FatherClassTemplateDocumentParser(modelService);
        parserFile = new XMLFileParser();

        fatherClass = parserDoc.parse(parserFile.parse(ResourceUtils
