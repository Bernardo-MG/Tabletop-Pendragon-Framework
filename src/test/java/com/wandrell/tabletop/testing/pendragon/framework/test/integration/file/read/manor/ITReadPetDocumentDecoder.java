...
import com.wandrell.tabletop.business.util.parser.xml.pendragon.input.manor.PetDocumentDecoder;
...
public final class ITReadPetDocumentDecoder {
    ...
    public ITReadPetDocumentDecoder() {
        super();
    }
    ...
    public final void initialize() throws Exception {
        ...
        final JDOMDocumentDecoder<Pet> processor;
        final ModelService modelService;

        modelService = TestServiceFactory.getInstance().getModelService();

        processor = new PetDocumentDecoder(modelService);
        parser = new StAXInputParser<Pet>(processor);
