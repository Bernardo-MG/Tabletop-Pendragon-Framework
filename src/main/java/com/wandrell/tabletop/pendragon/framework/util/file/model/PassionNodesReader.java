...
public final class PassionNodesReader implements
        NodesReader<Collection<Passion>> {

    public PassionNodesReader() {
        super();
    }

    @Override
    public final Collection<Passion> readNodes(final Collection<Element> nodes) {
