...
public final class HomelandTemplateDocumentParser implements
        Parser<Document, HomelandTemplate> {

    private final ModelService modelService;

    public HomelandTemplateDocumentParser(final ModelService service) {
        super();
    ...
    @Override
    public final HomelandTemplate parse(final Document doc) {
        final Element root;
        final Element bonus;
