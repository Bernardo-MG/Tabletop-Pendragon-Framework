...
public class WeaponDocumentParser implements Parser<Document, Weapon> {

    private final ModelService modelService;

    public WeaponDocumentParser(final ModelService service) {
        super();
    ...
    @Override
    public final Weapon parse(final Document doc) {
        final Element root;
        final Element flags;
