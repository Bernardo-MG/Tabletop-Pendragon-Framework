...
public class AdditionalBelongingsTableDocumentInputProcessor implements
        JDOMDocumentInputProcessor<AdditionalBelongingsTable> {
    ...
    public AdditionalBelongingsTableDocumentInputProcessor(
    ...
    @Override
    public final AdditionalBelongingsTable process(final Document doc) {
