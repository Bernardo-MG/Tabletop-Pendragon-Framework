...
public final class ReligionTemplateDocumentDecoder implements
        JDOMDocumentDecoder<ReligionTemplate> {

    private final ModelService modelService;

    public ReligionTemplateDocumentDecoder(final ModelService service) {
        super();
    ...
    @Override
    public final ReligionTemplate decode(final Document doc) {
        final Element root;
