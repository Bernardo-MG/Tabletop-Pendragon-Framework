...
public final class ReligionTemplateDocumentParser implements
        Parser<Document, ReligionTemplate> {

    private final ModelService modelService;

    public ReligionTemplateDocumentParser(final ModelService service) {
        super();
    ...
    @Override
    public final ReligionTemplate parse(final Document doc) {
        final Element root;
