...
public final class TextListDocumentDecoder implements
        JDOMDocumentDecoder<TextList> {

    private final ModelService modelService;

    public TextListDocumentDecoder(final ModelService service) {
        super();
    ...
    @Override
    public final TextList decode(final Document doc) {
        final Element root;
