...
public final class HomelandTemplateDocumentInputProcessor implements
        JDOMDocumentInputProcessor<HomelandTemplate> {

    private final ModelService modelService;

    public HomelandTemplateDocumentInputProcessor(final ModelService service) {
        super();
    ...
    @Override
    public final HomelandTemplate process(final Document doc) {
        final Element root;
        final Element bonus;
