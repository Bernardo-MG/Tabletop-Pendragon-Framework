...
public class PetDocumentDecoder implements JDOMDocumentDecoder<Pet> {

    private final ModelService modelService;

    public PetDocumentDecoder(final ModelService service) {
        super();
    ...
    @Override
    public final Pet decode(final Document doc) {
        final Element root;
